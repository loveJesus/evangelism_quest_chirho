...
export default function LoginPageChirho({ params: { lang } }: LoginPagePropsChirho) { 
  ...
  const [dictionary, setDictionary] = useState<DictionaryChirho['loginPage'] | null>(null);

  useEffect(() => {
    const fetchDict = async () => {
      const d = await getDictionaryChirho(lang);
      setDictionary(d.loginPage);
    };
    fetchDict();
  }, [lang]);
