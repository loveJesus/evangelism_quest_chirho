...
export default function ContextualGuidancePageChirho({ params: { lang } }: ContextualGuidancePagePropsChirho) {
  ...
  const [dictionary, setDictionary] = useState<DictionaryChirho['contextualGuidancePage'] | null>(null);

  useEffect(() => {
    const fetchDict = async () => {
      const d = await getDictionaryChirho(lang);
      setDictionary(d.contextualGuidancePage);
    };
    fetchDict();
  }, [lang]);
