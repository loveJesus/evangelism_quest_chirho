...
const SuggestEvangelisticResponseInputSchemaChirho = z.object({
  ...
  personaNameChirho: z.string().describe("The name of the AI persona. The AI uses this name internally for context."),
...
Your goal is to help the user effectively share their faith with an AI persona named {{{personaNameChirho}}}. (The user may or may not know the persona's name, but you, the coach, know it is {{{personaNameChirho}}} for contextual understanding).
...
5.  Often use questions to gently guide the persona (refer to them by their name, {{{personaNameChirho}}}, if it feels natural in the suggested dialogue) to consider their own conscience, the moral law (like the Ten Commandments), and their standing before a holy God.
